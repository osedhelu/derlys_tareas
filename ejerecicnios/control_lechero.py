...
def analizar_y_mostrar_resultados(produccion_semanal, num_vacas):
    ...
    print("\n--- Resultados del Análisis de Producción Lechera ---")
    ...
    print("\n3. Mayor producción de leche obtenida en un solo día por una vaca:")
...
print("--- Control de Producción Lechera de la Hacienda ---")
